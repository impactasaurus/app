...
const UsersInner = (): JSX.Element => {
  ...
  const newButton = (
    <span className="title-holder" style={{position: 'absolute', right: '1rem', marginTop: '0.5rem'}}>
      <Responsive as={Button} minWidth={620} icon="plus" content={t("Invite User")} primary={true} onClick={newClicked} loading={showInviteLink} />
      <Responsive as={Button} maxWidth={619} icon="plus" primary={true} onClick={newClicked} loading={showInviteLink} />
    </span>
  );
