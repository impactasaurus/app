...
export const DeltaReportDetails = (p: IProps) => {
  ...
  return (
    <ReportDetails
      introduction="This report shows whether the answers provided by your beneficiaries changed between their first and last records"
