...
const wrapper = (inner: JSX.Element): JSX.Element => {
  return <div className="record-question-summary">{inner}</div>;
};
...
const RecordQuestionSummaryConnected = connect(propsPreprocessing)(
  RecordQuestionSummaryInner
);
const RecordQuestionSummary = getMeeting<IProps>((props) => props.recordID)(
  RecordQuestionSummaryConnected
);
