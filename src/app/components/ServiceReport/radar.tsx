...
function getRadarSeries(t: (text: string) => string, aa: IAnswerAggregation[], labeller: (IAnswerAggregation) => string, indexer: (IAnswerAggregation) => number): IRadarSeries[] {
...
function getCategoryRadarData(t: (text: string) => string, p: IProp): RadarData {
  ...
  return {
    series: getRadarSeries(t, p.serviceReport.categories, getCatLabel, getCatIdx),
