  ...
  public render() {
    ...
    return (
      <div>
        <h1>{q.question}</h1>
        <h3>{q.description}</h3>
        <Likert key={'l-' + q.id} leftValue={q.minValue} rightValue={q.maxValue} leftLabel={q.minLabel} rightLabel={q.maxLabel} onChange={this.setAnswer} value={this.state.value} />
