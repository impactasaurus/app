...
const ListItemInner = (p: IProps) => {
  ...
  const {question, editQuestion, categoryPillStyle, deleteQuestion, readOnly} = p;
  const editButton = <Button onClick={editQuestion} icon="edit" tooltip={t("Edit")} compact={true} size="tiny" />;
  ...
  return (
    <List.Item className="question" key={question.id}>
      ...
      <List.Content floated="right" verticalAlign="middle">
        <CategoryPill outcomeSetID={p.outcomeSetID} questionID={question.id} readOnly={readOnly}
                      cssClass={categoryPillStyle} questionnaire={p.questionnaire}/>
