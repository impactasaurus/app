...
const Inner = (p: IProps) => {
  ...
  return (
    <OnboardingChecklistItem
      ...
      description={t("When a beneficiary completes a questionnaire, the data is stored as a record in the system. Complete a questionnaire to create your first record.")}
      completed={completed}
      loading={loading}
      link="/record"
      index={p.index}
